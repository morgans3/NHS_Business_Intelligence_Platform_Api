module.exports = {
    configureApis: async () => {
        ...
        try {
            ...
            console.error("Could not configure email settings");
        }
        ...
        try {
            ...
            console.error("Could not configure docobo settings");
        }
        ...
        try {
            ...
            console.error("Could not configure nice api credentials");
        }
        ...
        try {
            ...
            console.error("Could not configure confluence api settings");
        }
        ...
        try {
            ...
            console.error("Could not configure bth key settings");
        }
