...
router.post("/account/complete", (req, res, next) => {
    ...
    formSubmissionsModel.update(formData.parent_id, { 
        ...
        if (formData.action == "approve") {
            ...
            EmailHelper.sendMail({
                ...
                if (error) {
                    ...
                    res.json({ success: false, msg: "Request has been approved!" }); return;
                }
            });
        } else {
            ...
            EmailHelper.sendMail({
                ...
                if (error) {
                    ...
                    res.json({ success: false, msg: "Response has been recorded" }); return;
                }
            });
        }
    });
