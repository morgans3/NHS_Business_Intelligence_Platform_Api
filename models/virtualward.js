...
module.exports.getNewList = function (callback) {
    const query = `SELECT nhs_number, ccg_code, phone_number as contact, specimen_date, gpp_code, "id",
     age_in_years, ethnicity, age_band, forename, surname, postcode,
     date_of_birth FROM public.virtual_ward_decision as dec
